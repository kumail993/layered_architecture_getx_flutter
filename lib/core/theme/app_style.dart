...
class AppColors {
  ...
  static ColorGroup queenPink = ColorGroup(
    const Color(0xffE8D9DC),
    const Color(0xff804D57),
  );
  static ColorGroup blueViolet = ColorGroup(
    const Color(0xffC5C6E7),
    const Color(0xff3B3E91),
  );
  static ColorGroup rosePink = ColorGroup(
    const Color(0xffFCB1E0),
    const Color(0xffEC0999),
  );

  static ColorGroup rubinRed = ColorGroup(
    const Color(0x98f6a8bd),
    const Color(0xffd03760),
  );
  static ColorGroup favorite = rubinRed;
  static ColorGroup redOrange = ColorGroup(
    const Color(0xffFFAD99),
    const Color(0xffF53100),
  );
